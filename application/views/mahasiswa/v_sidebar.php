      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('mahasiswa/inputDraf') ?>"> DRAFT LAPORAN </a>
            <a class="collapse-item" href="<?php echo base_url('mahasiswa/inputDokAk') ?>">DOKUMEN AKHIR</a>
